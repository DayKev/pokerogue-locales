 ...
 * @returns A promise that resolves once rewording is complete
 */
async function reword(fileChoice: string, keyChoice: string, keyValue: string): Promise<void> {
  ...
  await deleteNonEnglishKeys(fileChoice, keyChoice);
...
async function deleteNonEnglishKeys(fileChoice: string, keyChoice: string): Promise<void> {
